    ...
    <article>
      <div className="relative rounded-lg group transition-all overflow-hidden">
        ...
        <div className="absolute top-0 left-0 0 w-full h-full bg-black/0 z-10 group-hover:bg-black/60 transition-all">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 bg-sky-500/0 group-hover:bg-sky-500 rounded-full h-10 w-10 flex justify-center items-center transition-all">
